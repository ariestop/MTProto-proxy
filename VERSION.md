# Версионирование проекта mtproxy — **1.2.5**
...
- Игнор **src** 172.16–31, **127.***, **`::ffff:172.16–31.*`** при опросе; те же IP не попадают в **отчёт** (агрегация в awk).
